...
\begin{frame}{The Wave Equation}
    \input{slides/wave-eq-intro}
\end{frame}


\begin{frame}{The Antenna Problem}
    \input{slides/antenna-problem}
\end{frame}

\section{Numerical Methods}

\begin{frame}{Discretization}
    \input{slides/numerical-discretization}    
\end{frame}

%\begin{frame}{Building Differentiation Matrices}
%    \input{slides/build-diffmat}
%\end{frame}

\begin{frame}{Building Differentiation Matrices (continued)}
    \input{slides/build-diffmat-ctd}
\end{frame}
...
\begin{frame}{Test Case - No Reflector}
    \input{slides/no-reflector-animation}
\end{frame}

\begin{frame}{Elliptical Reflector Dish}
    \input{slides/ellipse-animation}
\end{frame}
...
\begin{frame}{Parabolic Reflector}
    \input{slides/parabolic-animation}    
\end{frame}
